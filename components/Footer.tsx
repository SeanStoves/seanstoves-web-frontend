        ...
        <AppBar position="fixed" className={classes.Footer}>
            <Container maxWidth="xl" >
                <Toolbar disableGutters sx={{flexDirection: {xs: 'column', md: 'row'}}}>
                    <Box sx={{flexGrow: 2, display: {xs: 'flex', md: 'none'} }} alignItems="left" justifyContent="left">
                        <Button
                    ...
                    <Box sx={{flexGrow: 2, display: {xs: 'none', md: 'flex'}}} alignItems="center" justifyContent="center">
                        <Button
                            sx={{color: 'white', display: 'block'}}
                            variant="outlined"
                            component={Link}
                    ...
                    <Box sx={{flexGrow: 1, display: {xs: 'none', md: 'flex'}}} alignItems="left" justifyContent="left">
                            <Stack>
                                <Item><AlternateEmailRoundedIcon fontSize="small" /> sean@seanstoves.com</Item>
                                <Item><PhoneAndroidRoundedIcon fontSize="small"/> +1 570.778.5064</Item>
                            </Stack>
